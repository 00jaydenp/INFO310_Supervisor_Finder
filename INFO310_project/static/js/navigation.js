...
export const NavigationMenu = {
    ...
    <nav>
        ...
        <a href ="studentlist.html" v-if="signedIn && supervisorSignedIn">Student List</a>&nbsp
        <a href ="supervisorlookup.html" v-if="signedIn && studentSignedIn">Supervisor List</a>&nbsp
