...
public interface StudentJdbiDao extends StudentDao {
    ...
    @Override 
    @SqlUpdate("UPDATE STUDENT SET FIRSTNAME=:firstName, LASTNAME=:lastName, INTERESTS=:interests, DESCRIPTION=:description, PHONENUMBER=:phoneNumber, GPA=:gpa, ADDRESS=:address, PROJECTID = :project.projectID WHERE STUDENTID = :studentID")
